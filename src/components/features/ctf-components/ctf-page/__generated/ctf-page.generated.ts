...
export const useSuspenseCtfPageQuery = <
      TData = CtfPageQuery,
      TError = unknown
    >(
      variables: CtfPageQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<CtfPageQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<CtfPageQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<CtfPageQuery, TError, TData>(
      {
    queryKey: ['CtfPageSuspense', variables],
    queryFn: customFetcher<CtfPageQuery, CtfPageQueryVariables>(CtfPageDocument, variables),
    ...options
  }
    )};

useSuspenseCtfPageQuery.getKey = (variables: CtfPageQueryVariables) => ['CtfPageSuspense', variables];
